...
public class ResourceManager4XmlFile implements IResourceManager {
    ...
    protected List<Form> loadForms( Element element)  {
        ...
        for (int i=0; formElementList!=null && i<formElementList.size();i++){
            ...
            form.setEditFields(Util4Parser.elementAsString(formElm, FPDLNames.FORM_EDITFIELDS));
            form.setHiddenFields(Util4Parser.elementAsString(formElm, FPDLNames.FORM_HIDDENFIELDS));
            form.setOperateButtons(Util4Parser.elementAsString(formElm, FPDLNames.FORM_OPERATEBUTTONGS));
