...
//		ProcessInstanceVar target = new ProcessInstanceVar(source.getValueAsString(),source.getType());
//		return target;
	}
...
//			if (var0.getValueAsString() == null && var1.getValueAsString()==null) return true;
//			if (var0.getValueAsString()==null || var1.getValueAsString()==null)return false;
...
//			throw new SQLException("流程变量的数据类型只能是S-String,I-Integer,F-Float,B-boolean,D-Date之一");
//		}
...
//		if (var==null || var.getType()==null || var.getType().trim().equals("")){
//			throw new SQLException("流程变量的类型不可以为空");
//		}
