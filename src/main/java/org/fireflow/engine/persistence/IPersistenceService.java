...
public interface IPersistenceService extends IRuntimeContextAware{
    ...
    /**
     * 查找并返回所有业务流程的所有实例
     * (Engine没有引用到该方法，提供给业务系统使用，20140225)
     * @return A list of processInstance
     */
     ...
     * @return
     */
    public List<IWorkItem> findTodoWorkItemsByProcessInstanceId(String actorId,String processInstanceId);
     ...
     * @return
     */
    public List<IWorkItem> findTodoWorkItemsByProcessId(String actorId,String processId);
    ...
    /**
     * 查找操作员在某个流程实例某个任务上的待办工单。（李强20140607新增,目前用于取回）</br>
     * 待办工单是指状态等于INITIALIZED或STARTED工单<br/>
     * @param actorId
     * @param processId
     * @param taskId
     * @return
     */
    public List<IWorkItem> findTodoWorkItemsByWithdraw(String actorId,String processInstanceId,String taskId);
...
//	public String getBuzCodeForWorkitem(final String itemid);
	...
	/**
	 * 根据业务表单的buzCode获取待办信息
	 * 目前待办信息包括：【待办人、待办工单号】
	 * 待办人格式如下：
	 * 如果没有待办人，那么返回：空字符串  “”
	 * 如果待办人只有一个，那么返回：人名字符串  “account1”
	 * 如果待办人有多个，那么返回  ：用逗号隔开的人名字符串 “account1,account2,...,accountN”
	 * 待办工单的格式和待办人的格式类似
	 * @param buzCode
	 * @return
	 * @author ganyipeng
